...
from .models import XxgenInsuredDtls, XxgenInsuredAddress
# Create your views here.
from django.db import transaction, IntegrityError
from django.forms import modelformset_factory
from .forms import InsuredDtlsForm, InsuredAddressForm
        ...
        if Insuredform.is_valid() and formset.is_valid():
            try:
                with transaction.atomic():
                    ...
                    insured.created_by = str(request.user)
                    insured.last_updated_by = str(request.user)
